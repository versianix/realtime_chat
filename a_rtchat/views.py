    ...
    if chat_group.groupchat_name:
        if request.user not in chat_group.members.all():
            if request.user.emailaddress_set.filter(verified=True).exists():
                ...
                messages.warning(request, 'Você precisa verificar seu email para entrar no chat!')
...
def chatroom_edit_view(request, chatroom_name):
    ...
    return render(request, 'a_rtchat/edit_groupchat.html', context)
...
def chatroom_delete_view(request, chatroom_name):
    ...
    return render(request, 'a_rtchat/delete_groupchat.html', context)
...
def chatroom_leave_view(request, chatroom_name):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, 'Você saiu do chat!')
        return redirect('home')
